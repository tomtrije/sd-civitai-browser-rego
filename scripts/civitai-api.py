...
api_url = "https://ca.rego.vip/api/v1/models?limit=50"
json_data = None
                    ...
                    if model['name'] == model_version:
                        for file in model['files']:
                            if file['name'] == model_filename:
                                ...
                                dl_url = dl_url.replace('civitai.com', 'ca.rego.vip')
...
#from https://github.com/tomtrije/sd-civitai-browser-rego/blob/add-download-images/scripts/civitai-api.py
...
def on_ui_tabs():
    ...
    return (civitai_interface, "CivitAiRego", "civitai_interface_rego"),
